                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        // নাম এবং ছবির জন্য লজিক
                        final senderName = data['senderName'] ?? 'Unknown';
                        final String rawPhoto = data['senderPhoto'] ?? '';
                        
                        // ছবি না থাকলে নামের প্রথম অক্ষর দিয়ে ছবি জেনারেট করবে
                        final String photoUrl = rawPhoto.isNotEmpty
                            ? rawPhoto
                            : 'https://ui-avatars.com/api/?name=${Uri.encodeComponent(senderName)}&background=EBF4FF&color=2563EB&size=128';
